...
from prompt_flat_v1_4 import SYSTEM_PROMPT_V1_4, build_prompt_v1_4
...
for row in records:
    ...
    prompt = build_prompt_v1_4(review_text, json.dumps(meta, ensure_ascii=False, indent=2))
    ...
    try:
        ...
        extraction = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": SYSTEM_PROMPT_V1_4},
