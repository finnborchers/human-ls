...
from prompt_flat_v1_3 import SYSTEM_PROMPT_V1_3, build_prompt_v1_3
...
for row in records:
    ...
    prompt = build_prompt_v1_3(review_text, json.dumps(prompt_meta, ensure_ascii=False, indent=2))
    ...
    try:
        ...
        extraction = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": SYSTEM_PROMPT_V1_3},
        ...
        record = FlatReviewAnalysisRecord(
            ...
            metadata=FlatReviewMetadata(**output_meta),
