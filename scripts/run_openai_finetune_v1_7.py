...
TRAIN_JSONL_PATH = Path(
    os.getenv("FINETUNE_TRAIN_JSONL_PATH", str(FINETUNE_DIR / "reviews_v1_7_train_100.jsonl"))
)
VALID_JSONL_PATH = Path(
    os.getenv("FINETUNE_VALID_JSONL_PATH", str(FINETUNE_DIR / "reviews_v1_7_valid_20.jsonl"))
)
JOB_PATH = Path(
    os.getenv("FINETUNE_JOB_OUT_PATH", str(FINETUNE_DIR / "reviews_v1_7_finetune_job.json"))
)
